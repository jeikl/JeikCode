...
const zh = {
  ...
  'sidebar.mcpRefresh': '刷新 MCP 服务器',
  'sidebar.mcpReloading': '正在重载…',
  'sidebar.mcpReloaded': '已重载',
  'mcp.blockedUntrusted': '已拦截 {n} 个来自不受信任项目的 MCP server。',
  'mcp.trustProject': '信任本项目',
  'turnNav.title': '本轮提问',
  'turnNav.empty': '暂无提问',
  'turnNav.searchPlaceholder': '搜索提问…',
  'turnNav.noMatch': '无匹配提问',
  'sidebar.search': '搜索会话',
  ...
  'sidebar.delete': '删除',
  'sidebar.select': '多选',
  'sidebar.selectDone': '完成',
  'sidebar.selectAll': '全选',
  'sidebar.invertSelect': '反选',
  'sidebar.selectedCount': '已选 {n}',
  'sidebar.deleteSelected': '删除选中',
  'sidebar.deleteSelectedCount': '删除选中 ({n})',
  'sidebar.deletingCount': '正在删除 {n}…',
  ...
  'delete.bodyMany': '确定删除选中的 {n} 个会话吗？此操作不可撤销。',
  'delete.partialFailed': '{n} 个会话未能删除：{names}',
  ...
  'chat.detachedActive': '正在观察此会话的实时进度。发送会打断当前回合，并同步到所有视图。',
  'chat.detachedPolling': '后台回合进行中… 正在实时同步',
  'chat.detachedWatching': '正在实时同步此会话的回合进度…',
  'chat.detachedStopped': '已请求停止当前回合，可以继续发送。',
  'chat.activeCheckFailed': '无法确认会话运行状态：{error}',
  'chat.recoveryBlocked': '实时连接中断。发送会打断当前回合；也可点停止。',
  'chat.detachedSendBlocked': '正在观察此会话。发送会打断当前回合，并同步到所有视图。',
  'chat.inputPlaceholder': '输入消息…  （/ 唤起技能，@ 引用文件）',
  'chat.kbdHint': 'Enter 发送 · Shift+Enter 换行',
  'chat.stop': '停止',
  'chat.send': '发送',
  'chat.turnElapsedLive': '{time}',
  'chat.turnElapsedDone': '用时 {time}',
  'chat.turnClockLive': 'Current：{current}',
  'chat.turnClockDone': 'Current：{current}',
  ...
  'attach.removeFile': '移除文件',
  'attach.tooLarge': '图片不能超过 {mb}M，已自动忽略超限图片。',
  'attach.dropHint': '松开以上传文件',
  'attach.uploading': '正在上传 {name}（{current}/{total}）{percent}%',
  ...
  'settings.addAccount': '添加提供商',
  'settings.editAccount': '编辑提供商',
  'settings.accountName': '提供商名称/标识',
  'settings.accountSelect': '所属提供商',
  'settings.accountSelectNew': '＋ 新建提供商…',
  'settings.deleteAccountTitle': '删除提供商',
  'settings.deleteAccountConfirm': '确定删除提供商「{name}」？该提供商下的所有模型配置也将被移除。',
  'settings.modelsCount': '{n} 个模型',
  'settings.noModels': '暂无模型，点击右上角「＋添加模型」创建',
  'settings.expand': '展开',
  'settings.collapse': '折叠',
  'settings.expandAll': '展开全部',
  'settings.collapseAll': '折叠全部',
  'settings.modelConfigSubtitle': '统一管理 LLM 提供商凭据、Base URL 与各模型参数配置',
  'settings.activeDefaultModel': '当前默认模型',
  'settings.searchPlaceholder': '搜索提供商名称、模型标识、模型 ID…',
  'settings.noSearchResults': '未找到匹配的提供商或模型',
  'settings.resetSearch': '清除搜索条件',
  'settings.statsProviders': '{n} 个提供商',
  'settings.statsModels': '{n} 个模型',
  'settings.apiKeyConfigured': '已配置密钥',
  'settings.apiKeyNotConfigured': '未配置密钥',
  'settings.addModel': '添加模型',
  'settings.providerName': '模型别名',
  ...
  'settings.modelIdPlaceholder': '输入模型 ID，或刷新后筛选…',
  'settings.supportsVision': '支持图片输入',
  'settings.reasoningModel': '思考模型',
  'settings.reasoningEffort': '思考档位',
  'settings.reasoningHistory': '思考过程回传',
  'settings.effortDefault': '（默认）',
  'settings.historyInclude': 'include（回传思考）',
  'settings.historyExclude': 'exclude（不回传）',
  'settings.upstreamRefresh': '从上游刷新模型列表',
  'settings.upstreamNeedBaseUrl': '请先填写 Base URL，或选择已有提供商账号',
  'settings.upstreamFetching': '正在拉取上游模型列表…',
  'settings.upstreamLoaded': '已加载 {n} 个模型',
  'settings.upstreamEmpty': '上游未返回模型',
  'settings.upstreamFailed': '拉取失败',
  'settings.needAccountFirst': '请先添加提供商账号，再添加模型',
  'settings.inheritAccountCreds': '协议、Base URL 与 API Key 已由所选提供商配置',
  'settings.inheritAccountType': '协议：{type}（来自账号）',
  'settings.inheritAccountKey': 'API Key：使用账号已配置密钥',
  ...
  'cmd.new.desc': '开始新会话（清除对话）',
  'cmd.clear.desc': '清屏（不新建会话）',
  'cmd.sessions.desc': '打开侧栏列出并切换会话',
  'cmd.resume.desc': '打开会话侧栏（别名：/sessions）',
  'cmd.reload.desc': '从磁盘重载配置、MCP 与技能',
  'cmd.reload.done': '配置已重载（含 MCP）',
  'cmd.mcp.desc': 'MCP 服务器状态（/mcp reload 重连，/mcp trust 信任项目）',
  'cmd.mcp.header': 'MCP 服务器：',
  'cmd.mcp.reload.done': '已重新加载 MCP 配置并开始重连',
  'cmd.mcp.reload.failed': 'MCP 重载失败：{error}',
  'cmd.mcp.trust.ok': '已信任本项目，正在连接 MCP',
  'cmd.mcp.trust.failed': '信任项目失败：{error}',
  ...
  'cmd.model.deferred': '模型已保存，将在下一轮生效',
...
const en: Record<MsgKey, string> = {
  ...
  'sidebar.mcpRefresh': 'Reload MCP servers',
  'sidebar.mcpReloading': 'Reloading…',
  'sidebar.mcpReloaded': 'Reloaded',
  'mcp.blockedUntrusted': 'Blocked {n} MCP server(s) from an untrusted project.',
  'mcp.trustProject': 'Trust this project',
  'turnNav.title': 'Questions',
  'turnNav.empty': 'No questions yet',
  'turnNav.searchPlaceholder': 'Search questions…',
  'turnNav.noMatch': 'No matching questions',
  ...
  'sidebar.selectDone': 'Done',
  'sidebar.selectAll': 'Select all',
  'sidebar.invertSelect': 'Invert',
  'sidebar.selectedCount': '{n} selected',
  'sidebar.deleteSelected': 'Delete selected',
  'sidebar.deleteSelectedCount': 'Delete selected ({n})',
  'sidebar.deletingCount': 'Deleting {n}…',
  ...
  'delete.bodyMany': 'Delete {n} selected sessions? This cannot be undone.',
  'delete.partialFailed': '{n} sessions could not be deleted: {names}',
  ...
  'chat.detachedActive': 'Watching this session live. Sending interrupts the current turn and syncs every view.',
  'chat.detachedPolling': 'Background turn in progress… live syncing',
  'chat.detachedWatching': 'Live-syncing this session turn…',
  'chat.detachedStopped': 'The current turn was asked to stop; you can send again.',
  'chat.activeCheckFailed': 'Could not verify the session runtime state: {error}',
  'chat.recoveryBlocked': 'The live connection dropped. Sending interrupts the current turn; Stop still works.',
  'chat.detachedSendBlocked': 'Watching this session. Sending interrupts the current turn and syncs every view.',
  'chat.inputPlaceholder': 'Message…  (/ for skills, @ for files)',
  'chat.kbdHint': 'Enter to send · Shift+Enter for newline',
  'chat.stop': 'Stop',
  'chat.send': 'Send',
  'chat.turnElapsedLive': '{time}',
  'chat.turnElapsedDone': 'Took {time}',
  'chat.turnClockLive': 'Current：{current}',
  'chat.turnClockDone': 'Current：{current}',
  ...
  'attach.removeFile': 'Remove file',
  'attach.tooLarge': 'Images must be under {mb}M; oversized images were skipped.',
  'attach.dropHint': 'Drop files to upload',
  'attach.uploading': 'Uploading {name} ({current}/{total}) {percent}%',
  ...
  'settings.addAccount': 'Add Provider',
  'settings.editAccount': 'Edit Provider',
  'settings.accountName': 'Provider Name/ID',
  'settings.accountSelect': 'Provider Account',
  'settings.accountSelectNew': '＋ New Provider…',
  'settings.deleteAccountTitle': 'Delete Provider',
  'settings.deleteAccountConfirm': 'Delete provider "{name}"? All models under it will also be removed.',
  'settings.modelsCount': '{n} models',
  'settings.noModels': 'No models yet. Click "+ Add Model" to create one.',
  'settings.expand': 'Expand',
  'settings.collapse': 'Collapse',
  'settings.expandAll': 'Expand All',
  'settings.collapseAll': 'Collapse All',
  'settings.modelConfigSubtitle': 'Manage LLM provider credentials, Base URLs, and model parameters',
  'settings.activeDefaultModel': 'Default Model',
  'settings.searchPlaceholder': 'Search providers, model names, IDs…',
  'settings.noSearchResults': 'No matching providers or models found',
  'settings.resetSearch': 'Clear Search',
  'settings.statsProviders': '{n} providers',
  'settings.statsModels': '{n} models',
  'settings.apiKeyConfigured': 'Key Configured',
  'settings.apiKeyNotConfigured': 'No Key',
  'settings.addModel': 'Add model',
  'settings.providerName': 'Model alias',
  ...
  'settings.modelIdPlaceholder': 'Type a model ID, or refresh to filter…',
  'settings.supportsVision': 'Supports vision',
  ...
  'settings.historyInclude': 'include (send thinking back)',
  'settings.historyExclude': 'exclude (omit thinking)',
  'settings.upstreamRefresh': 'Refresh model list from upstream',
  'settings.upstreamNeedBaseUrl': 'Enter Base URL first, or pick an existing account',
  'settings.upstreamFetching': 'Fetching upstream models…',
  'settings.upstreamLoaded': 'Loaded {n} models',
  'settings.upstreamEmpty': 'Upstream returned no models',
  'settings.upstreamFailed': 'Fetch failed',
  'settings.needAccountFirst': 'Add a provider account before adding a model',
  'settings.inheritAccountCreds': 'Protocol, Base URL and API key come from the selected provider',
  'settings.inheritAccountType': 'Protocol: {type} (from account)',
  'settings.inheritAccountKey': 'API key: using the account key',
  ...
  'cmd.new.desc': 'Start a new session (clears conversation)',
  'cmd.clear.desc': 'Clear the screen (does not start a new session)',
  'cmd.sessions.desc': 'Open the sidebar to list and switch sessions',
  'cmd.resume.desc': 'Open the session sidebar (alias: /sessions)',
  'cmd.reload.desc': 'Reload config, MCP servers, and skills from disk',
  'cmd.reload.done': 'Config reloaded (including MCP)',
  'cmd.mcp.desc': 'MCP server status (/mcp reload to reconnect, /mcp trust this project)',
  'cmd.mcp.header': 'MCP servers:',
  'cmd.mcp.reload.done': 'MCP config reloaded; reconnecting',
  'cmd.mcp.reload.failed': 'MCP reload failed: {error}',
  'cmd.mcp.trust.ok': 'Project trusted; connecting MCP servers',
  'cmd.mcp.trust.failed': 'Trust failed: {error}',
  ...
  'cmd.model.deferred': 'Model saved; takes effect on the next turn',
