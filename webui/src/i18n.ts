...
const zh = {
  ...
  'attach.fileTooLarge': '文件不能超过 {mb}M，已自动忽略超限文件。',
  'attach.tooManyFiles': '最多附加 {n} 个文件，已忽略多余文件。',
  ...
  'settings.upstreamNeedBaseUrl': '请先填写 Base URL',
...
const en: Record<MsgKey, string> = {
  ...
  'attach.fileTooLarge': 'Files must be under {mb}M; oversized files were skipped.',
  'attach.tooManyFiles': 'At most {n} files can be attached; extra files were skipped.',
  ...
  'settings.providerName': 'Model Key/Name',
  ...
  'settings.upstreamNeedBaseUrl': 'Enter Base URL first',
