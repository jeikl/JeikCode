...
pub const BUNDLED_ASSETS: &[BundledFileEntry] = &[
    BundledFileEntry {
        ...
        content: include_str!("../../jeikcode-coding/assets/prompts/init.yaml"),
        description: "提示词与身份定义 (init.yaml)",
    },
    BundledFileEntry {
        relative_path: "prompts/rules.yaml",
        content: include_str!("../../jeikcode-coding/assets/prompts/rules.yaml"),
        description: "工作流与执行规范 (rules.yaml)",
    },
    BundledFileEntry {
        relative_path: "prompts/root_docs_prompts.md",
        content: include_str!("../../jeikcode-coding/assets/prompts/root_docs_prompts.md"),
        description: "提示词指南（不加载进模型） (root_docs_prompts.md)",
    },
    BundledFileEntry {
        relative_path: "prompts/root_docs_内置工具.yaml",
        content: include_str!("../../jeikcode-coding/assets/prompts/root_docs_内置工具.yaml"),
        description: "内置工具说明文档（不加载进模型） (root_docs_内置工具.yaml)",
    },
    BundledFileEntry {
        relative_path: "prompts/root_docs_内置技能.yaml",
        content: include_str!("../../jeikcode-coding/assets/prompts/root_docs_内置技能.yaml"),
