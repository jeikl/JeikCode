# jeikcode-kernel — Phase A0 Spike

Design-validation spike for the neutral-kernel platform strategy
(`docs/superpowers/specs/2026-06-05-jeikcode-kernel-platform-strategy.md`).
...
## Run
    ...
    cargo test -p jeikcode-kernel
    cargo run -p jeikcode-kernel --example minimal_specialization
