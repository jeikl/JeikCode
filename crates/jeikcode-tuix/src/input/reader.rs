// crates/jeikcode-tuix/src/input/reader.rs
...
impl Drop for ReaderHandle {
    fn drop(&mut self) {
        ...
        if self.focus_tracking_enabled {
            ...
            jeikcode_capabilities::notify::set_terminal_focus_state(None);
        }
...
pub fn spawn(tx: mpsc::UnboundedSender<InputEvent>) -> ReaderHandle {
    ...
    if focus_tracking_enabled {
        ...
        jeikcode_capabilities::notify::set_terminal_focus_state(Some(true));
    }
            ...
            if let Some(ev) = trailing {
                let msg = match ev {
                    ...
                    Event::FocusLost => {
                        ...
                        jeikcode_capabilities::notify::set_terminal_focus_state(Some(false));
                        continue;
                    }
                };
