// crates/jeikcode-tuix/src/state.rs
...
pub use jeikcode_coding::RuntimeMode as AgentMode;
...
pub struct UserInputPanel {
    ...
    pub header: String,
    pub question: String,
    pub mode: jeikcode_capabilities::tools::request_user_input::UserInputMode,
...
impl UserInputPanel {
    pub fn new(
        request_id: u64,
        r: &jeikcode_capabilities::tools::request_user_input::UserInputRequest,
    ) -> Self {
        ...
        let custom = matches!(
            r.mode,
            jeikcode_capabilities::tools::request_user_input::UserInputMode::Single
                | jeikcode_capabilities::tools::request_user_input::UserInputMode::Multiple
        );
    ...
    pub fn build_response(
        &self,
    ) -> Option<jeikcode_capabilities::tools::request_user_input::UserInputResponse> {
...
pub struct QueuedMessage {
    pub text: String,
    pub images: Vec<jeikcode_kernel::message::ImageContent>,
...
pub struct UiState {
    ...
    pub last_submitted_pasted_images: Vec<jeikcode_kernel::message::ImageContent>,
    ...
    pub pending_images: Vec<jeikcode_kernel::message::ImageContent>,
    ...
    pub goal_phase: jeikcode_coding::GoalPhase,
...
impl UiState {
    ...
    pub fn with_caps(unicode_symbols: bool, colors: bool) -> Self {
        Self {
            ...
            goal_phase: jeikcode_coding::GoalPhase::Pursuing,
            loop_label: None,
            loop_round: 0,
...
mod tests {
    ...
    fn session_image_count_survives_pending_images_drain() {
        ...
        s.pending_images
            .push(jeikcode_kernel::message::ImageContent {
    ...
    fn on_user_input_resolved_clears_panel_and_resumes() {
        use jeikcode_capabilities::tools::request_user_input::{UserInputMode, UserInputRequest};
        let mut s = UiState::new();
    ...
    fn pending_steers_retain_payload_and_drain_on_fold() {
        ...
        let confirmed = st.on_steered(&[jeikcode_kernel::event::SteeredInput {
            text: "one".into(),
            images: Vec::new(),
        ...
        assert!(
            st.on_steered(&[jeikcode_kernel::event::SteeredInput {
                text: "remote".into(),
                images: Vec::new(),
            }])
            .is_empty(),
