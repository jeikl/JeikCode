...
use jeikcode_kernel::event::ToolBatchCall;
use jeikcode_kernel::message::{ImageContent, SessionSnapshot};
...
pub enum UiEvent {
    ...
    GoalUpdate {
        active: bool,
        terminal: Option<jeikcode_coding::GoalTerminal>,
    ...
    SharedRequestResolved {
        request_id: jeikcode_kernel::event::RequestId,
        kind: String,
    },
    PeerBusy(bool),
