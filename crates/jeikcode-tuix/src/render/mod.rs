// crates/jeikcode-tuix/src/render/mod.rs
pub mod cell;
pub(crate) mod diff;
pub mod mascot;
pub mod plain;
...
pub trait Renderer: Send {
    ...
    fn notify_approval(
        &mut self,
        config: jeikcode_config::config::NotificationConfig,
        tool_name: String,
        detail: String,
        working_dir: std::path::PathBuf,
    ) {
        jeikcode_capabilities::notify::notify(
            &config,
            jeikcode_capabilities::notify::NotificationEvent::ApprovalNeeded(
                jeikcode_capabilities::notify::ApprovalNotification {
                    tool_name: &tool_name,
                    detail: Some(&detail),
...
pub struct GoalStatus {
    ...
    /// constructed).
    pub phase: jeikcode_coding::GoalPhase,
}
