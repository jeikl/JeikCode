// crates/jeikcode-tuix/src/render/worker.rs
//
...
fn ui_line_tag(l: &UiLine) -> &'static str {
    match l {
        ...
        UiLine::ReasoningHeader(_) => "ReasoningHeader",
        ...
        UiLine::ToolCallLiveTail { .. } => "ToolCallLiveTail",
...
mod tests {
    ...
    impl Renderer for TestRenderer {
        ...
        fn notify_approval(
            &mut self,
            _config: jeikcode_config::config::NotificationConfig,
            _tool_name: String,
            _detail: String,
    ...
    fn approval_notification_is_queued_on_worker() {
        ...
        r.notify_approval(
            jeikcode_config::config::NotificationConfig::default(),
            "Bash".into(),
            "rm /tmp/example".into(),
