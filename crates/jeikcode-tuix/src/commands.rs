// crates/jeikcode-tuix/src/commands.rs
...
const BUILTIN_COMMANDS: &[Command] = &[
    ...
    Command { name: "reload",  desc: "Reload ~/.jeikcode/config.toml from disk", needs_args: false, hidden: false },
    ...
    Command { name: "paste",   desc: "Attach an image from the clipboard (also Alt+V / Ctrl+Alt+V)", needs_args: false, hidden: false },
