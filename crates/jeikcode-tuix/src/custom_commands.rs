// crates/jeikcode-core/src/commands/mod.rs
//
...
impl CustomCommandRegistry {
    ...
    pub fn load(project_root: &Path) -> Self {
        ...
        Self::load_from_dir(
            &project_root.join(".jeikcode/commands"),
            None,
            &mut commands,
        );
        // Plugin layer
        for assets in
            jeikcode_capabilities::plugin::loader::iter_installed_plugin_assets_for(project_root)
        {
