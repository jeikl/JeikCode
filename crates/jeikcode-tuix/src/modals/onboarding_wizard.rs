// crates/jeikcode-tuix/src/modals/onboarding_wizard.rs
//
...
impl OnboardingWizard {
    ...
    pub(super) fn apply_language(
        ...
        store: &jeikcode_config::ConfigStore,
...
mod tests {
    ...
    fn blank_config_for_test() -> jeikcode_config::config::Config {
    ...
    fn draw_setup_lines_ascii_fallback_produces_pure_ascii_box() {
        let _g = jeikcode_config::i18n::test_lock();
        jeikcode_config::i18n::set_locale(jeikcode_config::i18n::Locale::En);
