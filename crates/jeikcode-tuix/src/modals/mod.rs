// crates/jeikcode-tuix/src/modals/mod.rs
//
...
// `crates/jeikcode-tuix/src/modals/`). This module only defines the
// trait + action enum.
...
pub trait Modal: Send {
    ...
    fn on_plugin_event(&mut self, _ev: &jeikcode_capabilities::plugin::PluginJobEvent) {}
