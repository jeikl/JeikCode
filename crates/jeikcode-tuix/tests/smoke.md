<!-- crates/jeikcode-tuix/tests/smoke.md -->
...
- [ ] `cargo test -p jeikcode-tuix 2>&1 | tail -5` → all 79 pass
- [ ] `cargo clippy -p jeikcode-tuix --all-targets 2>&1 | tail -10` → no warnings
...
- [ ] `~/.jeikcode/history` file exists and is readable
