...
mod tests {
    ...
    fn goal_lifecycle_diff_gets_state_machine_and_code_graph_plan() {
        let diff = r#"diff --git a/crates/jeikcode-core/src/agent/mod.rs b/crates/jeikcode-core/src/agent/mod.rs
--- a/crates/jeikcode-core/src/agent/mod.rs
+++ b/crates/jeikcode-core/src/agent/mod.rs
...
diff --git a/crates/jeikcode-bridge/src/runtime.rs b/crates/jeikcode-bridge/src/runtime.rs
--- a/crates/jeikcode-bridge/src/runtime.rs
+++ b/crates/jeikcode-bridge/src/runtime.rs
...
diff --git a/crates/jeikcode-tuix/src/event_loop/mod.rs b/crates/jeikcode-tuix/src/event_loop/mod.rs
--- a/crates/jeikcode-tuix/src/event_loop/mod.rs
+++ b/crates/jeikcode-tuix/src/event_loop/mod.rs
...
"#;
        ...
        assert!(
            plan.contains("crates/jeikcode-bridge/src/runtime.rs"),
            "{plan}"
        );
    }
    ...
    fn terminal_event_reordering_gets_contract_questions() {
        let diff = r#"diff --git a/crates/jeikcode-bridge/src/runtime.rs b/crates/jeikcode-bridge/src/runtime.rs
--- a/crates/jeikcode-bridge/src/runtime.rs
+++ b/crates/jeikcode-bridge/src/runtime.rs
