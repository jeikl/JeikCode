...
use jeikcode_capabilities::compaction::{OverflowCompaction, StubCompaction};
use jeikcode_kernel::agent::Agent;
use jeikcode_kernel::event::{AgentCommand, AgentEvent};
use jeikcode_kernel::message::{CompactTrigger, Message, Role};
...
async fn drive(handle: &mut jeikcode_kernel::agent::AgentHandle, text: &str) -> Vec<AgentEvent> {
    handle
        .commands
