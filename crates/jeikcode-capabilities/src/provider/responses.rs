...
/// Attribution stamped onto [`jeikcode_kernel::message::ReasoningBlock::provider`]
...
mod tests {
    use super::*;
    use jeikcode_kernel::message::{Message, ReasoningBlock};
    use jeikcode_kernel::provider::ReasoningEffort;
