...
//!
//! L1 placement: a tool may hold an [`LlmProvider`](jeikcode_kernel::provider::LlmProvider)
...
use jeikcode_kernel::agent::{Agent, AutoRespond, ToolLoopPolicy};
use jeikcode_kernel::event::StopReason;
use jeikcode_kernel::provider::LlmProvider;
use jeikcode_kernel::tool::{MountedTools, Tool, ToolContext, ToolResult};
