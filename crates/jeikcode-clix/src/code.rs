...
use jeikcode_kernel::event::{AgentEvent, StopReason};
use clap::Parser;
...
async fn finish(
    ...
    task: tokio::task::JoinHandle<jeikcode_coding::RuntimeExit>,
    ...
    loop {
        ...
        match ev {
            ...
            CodingRuntimeEvent::CompactionFinished {
                completion: jeikcode_coding::runtime::CompactionCompletion::Completed(outcome),
            } => {
                eprintln!(
                    "[compacted{}]",
            ...
            CodingRuntimeEvent::CompactionFinished {
                completion: jeikcode_coding::runtime::CompactionCompletion::Failed { error, .. },
            } => {
