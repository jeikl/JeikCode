...
const zh = {
  ...
  'setup.syncOrAddProvider': '手动添加 Provider。',
  ...
  'setup.signedInNextStep': '请添加 Provider 后开始对话。',
...
const en: Record<MsgKey, string> = {
  ...
  'setup.syncOrAddProvider': 'Add a provider manually.',
  ...
  'setup.signedInNextStep': 'Add a provider to start chatting.',
