...
class InputPanel(
    ...
    fun installKeyBindings(sendWithCtrlEnter: Boolean) {
        val enterAction = "jeikcode-input-enter"
        val ctrlEnterAction = "jeikcode-input-ctrl-enter"
        val shiftEnterAction = "jeikcode-input-shift-enter"
        val tabAction = "jeikcode-command-tab"
        val pasteAction = "jeikcode-input-paste"
        ...
        inputArea.inputMap.put(KeyStroke.getKeyStroke("UP"), "jeikcode-command-up")
        inputArea.actionMap.put("jeikcode-command-up", object : AbstractAction() {
            override fun actionPerformed(e: java.awt.event.ActionEvent?) {
        ...
        inputArea.inputMap.put(KeyStroke.getKeyStroke("DOWN"), "jeikcode-command-down")
        inputArea.actionMap.put("jeikcode-command-down", object : AbstractAction() {
            override fun actionPerformed(e: java.awt.event.ActionEvent?) {
                if (!moveCommandSelection(1)) {
        ...
        inputArea.inputMap.put(KeyStroke.getKeyStroke("ESCAPE"), "jeikcode-command-escape")
        inputArea.actionMap.put("jeikcode-command-escape", object : AbstractAction() {
            override fun actionPerformed(e: java.awt.event.ActionEvent?) {
                hideCommandPopup()
            }
        })
