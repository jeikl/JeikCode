...
class JeikCodeConfigurable : Configurable {
    ...
    private lateinit var contextLevel: JComboBox<JeikCodeContextLevel>
    ...
    override fun createComponent(): JComponent {
        ...
        autoSaveBeforeRead = JCheckBox("Auto-save files before JeikCode reads them")
        timeout = JSpinner(SpinnerNumberModel(30_000, 1_000, 300_000, 1_000))
        contextLevel = JComboBox(JeikCodeContextLevel.entries.toTypedArray())
    ...
    override fun apply() {
        settings.update {
            ...
            it.contextLevel = contextLevel.selectedItem as JeikCodeContextLevel
