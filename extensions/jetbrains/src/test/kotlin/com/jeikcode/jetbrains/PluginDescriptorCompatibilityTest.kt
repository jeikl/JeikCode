package com.jeikcode.jetbrains
...
class PluginDescriptorCompatibilityTest {
    ...
    fun jcefDependencyIsOptionalForCrossVersionCompatibility() {
        ...
        assertTrue(
            pluginXml.contains(
                """<depends optional="true" config-file="jeikcode-jcef.xml">com.intellij.modules.jcef</depends>""",
            ),
            "JCEF must be optional so pre-2025.3.1 IDEs can still load the plugin",
        )
        assertNotNull(
            javaClass.getResource("/META-INF/jeikcode-jcef.xml"),
