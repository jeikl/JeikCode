...
class SseParserTest {
    ...
    fun parsesDaemonSmokeProvidersPayloadShape() {
        val raw = """
            {
              "default_provider": "JeikCode-deepseek-v4-flash",
              "providers": [
                {
                ...
                },
                {
                  ...
                  "name": "JeikCode-deepseek-v4-flash",
        ...
        assertEquals("JeikCode-deepseek-v4-flash", raw.jsonString("default_provider"))
        ...
        assertEquals("JeikCode-deepseek-v4-flash", providers[1].jsonString("name"))
    ...
    fun parsesDaemonSmokeModelsAndSessionsPayloadShapes() {
        val models = """
            [
              ...
              {"provider":"JeikCode-deepseek-v4-flash","model":"deepseek-v4-flash","provider_type":"openai","is_default":true,"effort_applicable":true,"reasoning_effort":"max"}
            ]
        """.trimIndent()
        val sessions = """
            [
              {
                ...
                "name": "\u603b\u7ed3\u4fee\u6539\u7684\u5185\u5bb9\uff0c\u63d0\u4ea4\u4ee3\u7801",
                "working_dir": "/Users/example/jeikcode",
